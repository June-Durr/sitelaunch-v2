...
const Testimonials = () => {
  // Updated testimonials with simple avatar fallbacks
  const testimonials = [
    {
      quote:
      ...
      image: null, // We'll use initials fallback
      initials: "BM",
        ...
        >
          ...
          <div className="relative px-8 py-12 md:px-16 md:py-16 z-10">
            <AnimatePresence mode="wait">
              ...
              >
                {/* Testimonial image - Simple colored avatar with initials */}
                <div className="w-24 h-24 md:w-32 md:h-32 rounded-full overflow-hidden border-4 border-primary-100 flex-shrink-0">
                  <div
                    className={`w-full h-full ${testimonials[currentIndex].color} flex items-center justify-center text-white font-bold text-lg md:text-xl`}
                  >
