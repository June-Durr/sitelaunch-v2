        ...
        >
          ...
          >
            ...
            <div className="relative flex justify-center items-center h-[420px]">
              ...
              {/* Mobile-specific background devices */}
              <div className="md:hidden absolute -left-8 top-[50px] z-10 bg-white shadow-xl rounded-2xl border border-gray-200 w-32 h-[220px] transform -rotate-12 opacity-70">
                {/* Simplified tablet content for mobile */}
                <div className="h-3 w-8 bg-gray-300 mx-auto rounded-b-lg"></div>
                <div className="bg-gray-50 h-full p-2">
                  {/* Simplified UI elements */}
                  <div className="h-4 bg-gradient-to-r from-primary-600 to-purple-600 rounded-md w-full"></div>
                  <div className="h-12 mt-2 bg-gradient-to-br from-gray-900 via-gray-800 to-primary-900 rounded-md w-full relative overflow-hidden">
                    <div className="absolute inset-0 flex flex-col justify-center items-center">
                      <div className="h-1 bg-white/80 rounded-full w-12 mb-1"></div>
                      <div className="h-3 w-10 bg-secondary-500 rounded-sm"></div>
                    </div>
                  </div>
                  <div className="h-1.5 bg-gray-300 rounded-full w-full mt-2"></div>
                  <div className="h-1.5 bg-gray-300 rounded-full w-3/4 mt-1"></div>
                  <div className="h-4 bg-secondary-500 rounded-md w-12 mt-2"></div>
                </div>
              </div>

              <div className="md:hidden absolute -right-8 top-[50px] z-10 bg-white shadow-xl rounded-lg border border-gray-200 w-32 h-[200px] transform rotate-12 opacity-70">
                {/* Simplified desktop content for mobile */}
                <div className="h-3 bg-gray-100 border-b border-gray-200 rounded-t-lg flex items-center px-1">
                ...
                <div className="p-2 bg-gray-50 h-full">
                  {/* Simplified UI elements */}
                  <div className="h-3 bg-gradient-to-r from-primary-600 to-purple-600 rounded-md w-16 mb-2"></div>
                  <div className="h-10 bg-gradient-to-br from-gray-900 via-gray-800 to-primary-900 rounded-md mb-2 relative">
                    <div className="absolute inset-0 flex flex-col justify-center p-1">
                      <div className="h-1 bg-white/60 rounded-full w-10 mb-1"></div>
                      <div className="flex">
                        <div className="h-2 w-6 bg-secondary-500 rounded-sm text-[3px] text-white flex items-center justify-center">
                          START
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="h-3 bg-secondary-500 rounded-md w-12 mt-2"></div>
                </div>
              </div>

              {/* Tablet - behind left - Only visible on desktop */}
              <div className="hidden md:block absolute left-[7rem] top-6 z-20 bg-white shadow-xl rounded-2xl border border-gray-200 w-52 h-[350px] transform -rotate-6">
              ...
              {/* Desktop - behind right - Only visible on desktop */}
              <div className="hidden md:block absolute right-16 top-12 z-10 bg-white shadow-xl rounded-lg border border-gray-200 w-80 h-[300px] transform rotate-6">
              ...
              <div className="absolute md:left-32 left-2 md:bottom-6 bottom-6 z-40 bg-white rounded-lg shadow-md py-1 px-2 flex items-center border border-primary-100">
                <span className="text-xs font-medium text-gray-600 mr-1">
                  Mobile-First:
                </span>
              ...
              <div className="absolute md:right-24 right-2 md:bottom-10 bottom-16 z-40 bg-white rounded-lg shadow-md py-1 px-2 flex items-center border border-secondary-100">
                <span className="text-xs font-medium text-gray-600 mr-1">
                  Conversion:
                </span>
