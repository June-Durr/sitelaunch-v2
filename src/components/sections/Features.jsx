...
const Features = () => {
  const features = [
    ...
    },
    {
      ...
      title: "Fast Loading",
      description:
        "Optimized for speed to ensure visitors stay engaged and dont bounce due to slow load times.",
    },
  ];
      ...
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xl text-gray-600">
            Our platform provides all the tools you need to build, optimize, and
